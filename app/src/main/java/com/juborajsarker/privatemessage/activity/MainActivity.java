...
import com.juborajsarker.privatemessage.fragment.OriginalFragment;
import com.juborajsarker.privatemessage.fragment.SecretFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SecretFragment(), "Make Private");
        adapter.addFragment(new OriginalFragment(), "Return Original");
    ...
    public void share_app(MenuItem item) {
        ...
        intent.setType("*/*");
        intent.createChooser(intent, "Private Message");
        intent.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(new File(filePath)));
        startActivity(Intent.createChooser(intent, "share Private Message using"));
